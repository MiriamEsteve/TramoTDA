...
def plot_persistence_diagrams(diagrams, filename):
    ...
    labels=[]
    for index, (diagram, color) in enumerate(zip(diagrams, colors)):
        labels.append(f'Trajectory {index + 1}')  # Generating labels dynamically
...
def create_flowchart():
    image_paths = [
        ...
        '2. Generate Persistence Diagrams: Transform the trajectory data into persistence diagrams, capturing topological features that persist across various scales of the data.'),
