...
def main():
    datas = simulate_trajectory_data()
    plot_trajectory_data(datas, '1_Load_Trajectory_Data.png')
    
    diagrams = generate_persistence_diagrams(datas)
    ...
    X, y, report = perform_classification()
    plot_classification(X, y, '6_Classification.png')
    plot_evaluation_and_refinement(report, '7_Evaluation_and_Refinement.png')
